...
class ApprovalsProcessor extends Component
{
    ...
    public function approveCreateMember($branchId,$approvalsId)
    {
    ...
    public function rejectCreateMember($branchId,$approvalsId)
    {
    ...
    ///
    ///
    public function approveDeleteMember($branchId,$approvalsId)
    {
    ...
    public function rejectDeleteMember($branchId,$approvalsId)
    {
    ...
    /// ///////////////////////////////////////////////////////////////
    ///
    public function approveEditMember($branchId,$approvalsId,$changes)
    {
        $changes = json_decode($changes, true);
        foreach($changes as $key => $value){
