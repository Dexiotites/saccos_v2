...
class ApprovalsList extends Component
{
    ...
    public function approveCreateMember($memberId,$approvalsId)
    {

        Members::where('id', $memberId)->update([
            'member_status' => 'Active'
        ]);
        $membership_number =  Members::where('id', $memberId)->value('membership_number');
    ...
    public function rejectCreateMember($memberId,$approvalsId)
    {
    ...
    ///
    ///
    public function approveDeleteMember($memberId,$approvalsId)
    {
    ...
    public function rejectDeleteMember($memberId,$approvalsId)
    {
    ...
    /// ///////////////////////////////////////////////////////////////
    ///
    public function approveEditMember($memberId,$approvalsId,$changes)
    {
        $changes = json_decode($changes, true);
        foreach($changes as $key => $value){
            $dbValue = Members::where('id',$memberId)->value($key);
            if($dbValue != $value){
                Members::where('id', $memberId)->update([
                    $key => $value
                ]);
    ...
    public function rejectEditMember($approvalsId)
    {
