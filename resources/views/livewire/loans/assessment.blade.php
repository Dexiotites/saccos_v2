            ...
            <div class="w-1/3 bg-white rounded px-6 rounded-lg shadow-sm   pt-4 pb-4 " >
                ...
                <input type="number" id="principle_amount" name="principle_amount"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm
                 ...
                 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                       wire:model.lazy="principle_amount" @disabled(Session::get('disableInputs')) required>
                ...
                @if(Session::get('loanStatus') == 'Pending')
                ...
                @if(Session::get('loanStatus') == 'Awaiting Approval' && Session::get('viewLoansWithCategory') == 'Committee')
                    <div class="flex justify-end w-auto" >
                        <div wire:loading.remove wire:target="actionBtns" >
                ...
                @if(Session::get('loanStatus') == 'Approved' && Session::get('viewLoansWithCategory') == 'Accounting')
