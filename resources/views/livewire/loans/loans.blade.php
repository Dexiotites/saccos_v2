                ...
                <div class="flex items-center mb-2 space-x-2 text-sm font-semibold spacing-sm text-slate-600 h-auto">
                    ...
                    <div>
                        ...
                        <table class="min-w-full text-center text-sm font-light">
                            <thead>
                                <tr>
                                    <th>LOANS MANAGEMENT</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Active Loans</td>
                                    <td class="whitespace-nowrap text-left">{{ $this->activeLoansCount }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Inactive Loans</td>
                                    <td class="whitespace-nowrap text-left">{{ $this->inactiveLoansCount }}</td>
                                </tr>
                            </tbody>
                        </table>
