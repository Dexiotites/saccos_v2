    ...
    <div class="row-span-1 col-span-1 bg-slate-50 border-r flex flex-col">
        ...
        <div class="h-16 border-b flex justify-between items-center w-full px-5 py-2 shadow-sm bg-white">
            <div class="flex items-center">
                ...
                <p class="font-semibold ml-3 text-slate-600">Procurement</p>
            </div>
        ...
        <div class="h-full">
            ...
            <div wire:click="menuItemClicked(1)"
                ...
                <div class="">
                    <p  class="text-md font-semibold text-slate-600 m-0 p-0">Manage purchase orders
                    </p>
                    <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Manage purchase orders</p>
                </div>
            </div>
            ...
            <div wire:click="menuItemClicked(2)"
                 class="@if( $tab_id == 2 ) border-l-blue-400 border-t border-b  bg-white @else border-l-transparent @endif
                        px-5 py-4   flex items-center cursor-pointer border-l-4 hover:bg-slate-100">
                <div class="">
                    <p  class="text-md font-semibold text-slate-600 m-0 p-0">Create purchase orders
                    </p>
                    <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Create purchase orders</p>
                </div>
            </div>
            ...
            <div wire:click="menuItemClicked(4)"
                 class="@if( $tab_id == 3 ) border-l-blue-400 border-t border-b  bg-white @else border-l-transparent @endif
                        px-5 py-4   flex items-center cursor-pointer border-l-4 hover:bg-slate-100">
                <div class="">
                    <p  class="text-md font-semibold text-slate-600 m-0 p-0">Receive and process invoices
                    </p>
                    <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Receive and process invoices</p>
                </div>
            </div>
            ...
            <div wire:click="menuItemClicked(5)"
                 class="@if( $tab_id == 3 ) border-l-blue-400 border-t border-b  bg-white @else border-l-transparent @endif
                        px-5 py-4   flex items-center cursor-pointer border-l-4 hover:bg-slate-100">
                <div class="">
                    <p  class="text-md font-semibold text-slate-600 m-0 p-0">Manage vendor relationships
                    </p>
                    <p class="text-xs text-slate-400 -mt-0.5 font-semibold" >Manage vendor relationships</p>
                </div>
            </div>
