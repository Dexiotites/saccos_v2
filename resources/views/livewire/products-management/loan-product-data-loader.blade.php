        ...
        <div class="w-1/4" >
            ...
            <div class="flex justify-between gap-2">
                <div class="w-1/2">
                    ...
                    <input wire:model.bounce="principle_min_value" type="number" id="principle_min_value" class="w-20 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs
                ...
                <div class="w-1/2">
                    ...
                    <input wire:model.bounce="principle_max_value" type="number" id="principle_max_value" class="w-20 p-2 text-gray-900 border
