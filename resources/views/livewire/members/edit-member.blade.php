                            ...
                            <div class="mt-10 sm:mt-0">
                                <x-jet-form-section submit="updateImage">
                                    ...
                                    <x-slot name="description">
                                        {{ __('Member image for visual identification.') }}
                                    </x-slot>
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
                                            ...
                                            <x-slot name="content">
                                                ...
                                                <div class="mt-4" x-data="{}" x-on:confirming-delete-user.window="setTimeout(() => $refs.password.focus(), 250)">
                                                    <x-jet-input type="password" class="mt-1 block w-3/4"
                                                                 ...
                                                                 wire:keydown.enter="suspendMember" />
                                            ...
                                            <x-slot name="footer">
                                                ...
                                                <x-jet-danger-button class="ml-3" wire:click="suspendMember" wire:loading.attr="disabled">
                                                    {{ __('Suspend This Member') }}
                                                </x-jet-danger-button>
                                            </x-slot>
                                        </x-jet-dialog-modal>
