                ...
                <div class="flex items-center mb-2 space-x-2 text-sm font-semibold spacing-sm text-slate-600 h-auto">
                    ...
                    <div>
                        ...
                        <table class="min-w-full text-center text-sm font-light">
                            <thead>
                                <tr>
                                    <th>TRANSACTIONS RECONCILIATION</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Matched Transactions</td>
                                    <td class="whitespace-nowrap text-left"></td>
                                </tr>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Non Matching Transactions</td>
                                    <td class="whitespace-nowrap text-left"></td>
                                </tr>
                            </tbody>
                        </table>
