                ...
                <div class="flex items-center mb-2 space-x-2 text-sm font-semibold spacing-sm text-slate-600 h-auto">
                    ...
                    <div>
                        ...
                        <table class="min-w-full text-center text-sm font-light">
                            <thead>
                                <tr>
                                    <th>BRANCHES MANAGEMENT</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Active Branches</td>
                                    <td class="whitespace-nowrap text-left">{{ $this->activeBranchesCount }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-nowrap font-medium text-left">Inactive Branches</td>
                                    <td class="whitespace-nowrap text-left">{{ $this->inactiveBranchesCount }}</td>
                                </tr>
                            </tbody>
                        </table>
...
<!-- Log Out Other Devices Confirmation Modal -->
<x-jet-dialog-modal wire:model="showDeleteBranch">
    <x-slot name="title">
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showDeleteBranch')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-jet-secondary-button>
...
<x-jet-dialog-modal wire:model="showAddBranch">
            ...
            @endif
                ...
                <div class="bg-white p-4">
                    ...
                    <div >
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            <x-jet-label for="phone_number" value="{{ __('Phone Number') }}" />
                            <x-jet-input id="phone_number" type="number" class="mt-1 block w-full" wire:model.defer="phone_number"  required />
                            <x-jet-input-error for="phone_number" class="mt-2" />
                        </div>
    ...
    <x-slot name="footer">
        <x-jet-secondary-button wire:click="$toggle('showAddBranch')" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-jet-secondary-button>
